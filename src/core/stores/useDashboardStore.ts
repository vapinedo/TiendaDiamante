...
import useBarrioStore from '@app/core/stores/useBarrioStore';
import useArticuloStore from '@app/core/stores/useArticuloStore';
    ...
    set => ({
      ...
      fetchTotals: async () => {
        try {
          ...
          await Promise.all([useBarrioStore.getState().getTotalRecords(), useArticuloStore.getState().getTotalRecords()]);
